...
emmet.exec(function(require, _) {
    ...
    /**
     * Check if parsed node contains output placeholder 每 a target where
...
emmet.define('handlerList', function(require, _) {
    ...
    HandlerList.prototype = {
         ...
         * <b>order</b> : (<code>Number</code>) 每 order in handler list. Handlers
...
emmet.define('actions', function(require, _, zc) {
    ...
    return {
         ...
         * <b>label</b> : (<code>String</code>) 每 Human-readable action name.
         * May contain '/' symbols as submenu separators<br>
         * <b>hidden</b> : (<code>Boolean</code>) 每 Indicates whether action
...
emmet.define('tabStops', function(require, _) {
    ...
    return {
         ...
         *
         * <b>tabstop</b> : <code>Function</code> 每 a tabstop handler. Receives
         * a single argument 每 an object describing token: its position, number
         * group, placeholder and token itself. Should return a replacement
         * string that will appear in final output
         *
         * <b>variable</b> : <code>Function</code> 每 variable handler. Receives
         * a single argument 每 an object describing token: its position, name
        ...
        variablesResolver: function(node) {
            ...
            return function(str, varName) {
                // do not mark `child` variable as placeholder 每 it＆s a reserved
                // variable name
                if (varName == 'child')
                    return str;
 ...
 * remove properties from it每all changes will be immediately reflected in the
 * original source.
 * <br><br>
...
emmet.exec(function(require, _) {
    ...
    function makePossibleRangesCSS(property) {
        ...
        // some examples:
        // 每 1px solid red: 3 parts
        // 每 arial, sans-serif: enumeration, 2 parts
        // 每 url(image.png): function value part
...
emmet.define('reflectCSSValue', function(require, _) {
     ...
     * browsers. For example: op忘city:0.5; ↙ filter:alpha(opacity=50);<br><br>
     *
    ...
    function findGradientFromPosition(content, pos) {
        ...
        if (cssRule) {
            ...
            if (!cssProp) {
                ...
                // and didn't include semicolon每try another approach
...
//				}
     ...
     * <li>Double underscore (or typographic '每') is also treated as an element
...
emmet.exec(function(require, _) {
    ...
    prefs.define('filter.commentAfter',
        ...
        + '<li><code>attr(name, before, after)</code> 每 a function that outputs'
        + 'specified attribute value concatenated with <code>before</code> '
        + 'and <code>after</code> strings. If attribute doesn\'t exists, the '
        + 'empty string will be returned.</li>'

        + '<li><code>node</code> 每 current node (instance of <code>AbbreviationNode</code>)</li>'

        + '<li><code>name</code> 每 name of current tag</li>'

        + '<li><code>padding</code> 每 current string padding, can be used '
        + 'for formatting</li>'
 ...
 * <br><br>
 * Examples to test:<br>
 * <code>lipsum</code> 每 generates 30 words text.<br>
 * <code>lipsum*6</code> 每 generates 6 paragraphs (autowrapped with &lt;p&gt; element) of text.<br>
 * <code>ol>lipsum10*5</code> 〞 generates ordered list with 5 list items (autowrapped with &lt;li&gt; tag)
 * with text of 10 words on each line<br>
 * <code>span*3>lipsum20</code> 每 generates 3 paragraphs of 20-words text, each wrapped with &lt;span&gt; element .
...
emmet.define('lorem', function(require, _) {
    var langs = {
        ...
        ru: {
            common: ['忱忘抖快抗抉-忱忘抖快抗抉', '戒忘', '扼抖抉志快扼扶抑技我', '忍抉把忘技我', '志 扼找把忘扶快', '忍抖忘扼扶抑抒', '我 扼抉忍抖忘扼扶抑抒', '忪我志批找', '把抑忌扶抑快', '找快抗扼找抑'],
            words: ['志忱忘抖我', '抉找 志扼快抒', '抉扶我', '忌批抗志快扶扶抑抒', '忱抉技忘抒', '扶忘 忌快把快忍批', '扼快技忘扶找我抗忘',
                '忌抉抖抆扮抉忍抉', '攸戒抑抗抉志抉忍抉', '抉抗快忘扶忘', '技忘抖快扶抆抗我抄', '把批折快快抗', '忱忘抖抆',
                '忪批把折我找', '扭抉 志扼快抄', '抉忌快扼扭快折我志忘快找', '快快','志扼快技我', '扶快抉忌抒抉忱我技抑技我',
                '扭把忘志我抖忘技我', '改找忘', '扭忘把忘忱我忍技忘找我折快扼抗忘攸', '扼找把忘扶忘', '抗抉找抉把抉抄', '忪忘把快扶扶抑快',
                '扭把快忱抖抉忪快扶我攸', '戒忘抖快找忘攻找', '扭把攸技抉', '把抉找', '忱忘忪快', '志扼快技抉忍批投忘攸',
                '扭批扶抗找批忘扯我攸', '扶快', '我技快快找', '志抖忘扼找我', '扶忘忱', '把抑忌扶抑技我', '找快抗扼找忘技我',
                '志快忱批投我技我', '忌快戒抉把扳抉忍把忘扳我折扶抑抄', '抉忌把忘戒', '忪我戒扶我', '抉忱扶忘忪忱抑', '抉忱扶忘',
                '技忘抖快扶抆抗忘攸', '扼找把抉折抗忘','把抑忌扶抉忍抉', '找快抗扼找忘', '我技快扶我', 'lorem', 'ipsum',
                '把快扮我抖忘', '志抑抄找我', '忌抉抖抆扮抉抄', '技我把', '忍把忘技技忘找我抗我', '志快抖我抗我抄', '抉抗扼技抉抗扼',
                '扭把快忱批扭把快忪忱忘抖', '抉', '戒抖抑抒', '戒忘扭攸找抑抒', '忱我抗我抒', '戒扶忘抗忘抒', '志抉扭把抉扼忘',
                '抗抉志忘把扶抑抒', '找抉折抗忘抒', '戒忘扭攸找抉抄', '扶抉', '找快抗扼找', '忱忘抖', '扼忌我找抆',
                '扼快忌攸', '找抉抖抗批', '抉扶', '扼抉忌把忘抖', '扼快技抆', '扼志抉我抒', '戒忘忍抖忘志扶抑抒', '忌批抗志',
                '扭抉忱扭抉攸扼忘抖', '我扶我扯我忘抖', '戒忘', '扭抉攸扼', '扭批扼找我抖扼攸', '忱抉把抉忍批',
                '志戒抉忌把忘志扮我扼抆', '扭快把志批攻', '志快把扮我扶批', '抗批把扼我志扶抑抒', '忍抉把', '忌把抉扼我抖',
                '扭抉扼抖快忱扶我抄', '志戒忍抖攸忱', '扶忘戒忘忱', '扼我抖批改找', '扼志抉快忍抉', '把抉忱扶抉忍抉', '忍抉把抉忱忘',
                '忌批抗志抉忍把忘忱', '戒忘忍抉抖抉志抉抗', '忱快把快志扶我', '忘抖扳忘志我找', '扭抉忱戒忘忍抉抖抉志抉抗', '扼志抉快忍抉',
                '扭快把快批抖抗忘', '忍把批扼找扶抑抄', '把快找抉把我折快扼抗我抄', '志抉扭把抉扼', '扼抗忘找我抖扼攸', '快忍抉',
                '投快抗快', '扭把抉忱抉抖忪我抖', '扼志抉抄', '扭批找抆', '忱抉把抉忍快', '志扼找把快找我抖', '把批抗抉扭我扼抆',
                '抉扶忘', '扭把快忱批扭把快忱我抖忘',  '技抉快抄', '志扼快', '扭快把快扭我扼抑志忘快找扼攸', '扶快扼抗抉抖抆抗抉',
                '把忘戒', '快忱我扶扼找志快扶扶抉快', '折找抉', '技快扶攸', '抉扼找忘抖抉扼抆', '改找抉', '扭把我扼找忘志抗忘',
                '志抉戒志把忘投忘抄扼攸', '找抑', '抖批折扮快', '扼志抉攻', '忌快戒抉扭忘扼扶批攻', '扼找把忘扶批', '扭抉扼抖批扮忘志扮我扼抆',
                '把批抗抉扭我扼我', '扶忘扮', '扭把抉忱抉抖忪我抖', '扼志抉抄', '扭批找抆', '志扼抗抉把快', '快技批',
                '扭抉志扼找把快折忘抖扼攸', '抗抉志忘把扶抑抄', '扼抉扼找忘志我找快抖抆', '把快抗抖忘技扶抑抒', '找快抗扼找抉志',
                '扶忘扭抉我志扮我抄', '攸戒抑抗抉技', '把快折抆攻', '戒忘技忘扶我志扮我抄', '扼志抉快', '忘忍快扶扼找志抉',
                '抗抉找抉把抉快', '我扼扭抉抖抆戒抉志忘抖抉', '扼扶抉志忘', '扼扶抉志忘', '扼志抉我抒', '扭把抉快抗找忘抒',
                '快扼抖我', '扭快把快扭我扼忘抖我', '找抉', '忪我志快找', '找忘技', '忱抉', '扼我抒', '扭抉把']
        }
    };
